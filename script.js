    ...
    return (tasks.innerHTML += `
             ...
             <span class="fw-bolder">${ele.text}</span>
              <span class="fw-bolder">${ele.date}</span>
               ...
               <span class="options">
               <i onclick="editTask(this)" data-bs-toggle="modal" data-bs-target="#form" class="fa-solid fa-pen-to-square fa-beat fa-lg" style="color: #FFD43B;"></i>
               <i onclick="deleteTask(this); createTask()" class="fa-solid fa-trash fa-beat fa-lg" style="color: #FFD43B;"></i>
               </span>
               </div>
            `);
  });
